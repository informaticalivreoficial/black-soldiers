...
{{-- Body --}}
    <div style="width:100%; padding:10px;">        
        ...
        <div style="background:#FFF; font:16px Trebuchet MS, Arial, Helvetica, sans-serif; color:#333; line-height:150%;">       
            <h1 style="font-size:20px; color:#000; background:#F4F4F4; padding:10px;">Dados da Solicitação</h1>
            ...
            <br />
            <strong>Tipo de Serviço: </strong><strong style="color:#09F;">{{ $tipo }}</strong>
            <br />
